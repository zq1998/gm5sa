...
public class xueba_Activity extends AppCompatActivity {
...
//        }
        ...
        navView.setCheckedItem(R.id.nav_xueba);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_xingbie:
                        Intent intent=new Intent(xueba_Activity.this,xingbie_Activity.class);
                        startActivity(intent);
                        xueba_Activity.this.finish();
                        break;
                    case R.id.nav_xuesheng:
                        Intent intent1=new Intent(xueba_Activity.this,xuesheng_Activity.class);
                        startActivity(intent1);
                        xueba_Activity.this.finish();
                        break;
                    case R.id.nav_xiaofei:
                        Intent intent2=new Intent(xueba_Activity.this,xiaofei_Activity.class);
                    ...
                    case R.id.nav_zhaosheng:
                        Intent intent4=new Intent(xueba_Activity.this,zhaosheng_Activity.class);
                        startActivity(intent4);
                        xueba_Activity.this.finish();
                        break;
                    case R.id.nav_jiuye:
                        Intent intent5=new Intent(xueba_Activity.this,jiuye_Activity.class);
                        startActivity(intent5);
                        xueba_Activity.this.finish();
                        break;
                    case R.id.nav_guanyu:
                        Toast.makeText(xueba_Activity.this,"中国石油大学  gm5s",Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
...
//                break;
    ...
    private void initView() {
        ...
        webView2.loadUrl("http://gm5s.tech:88/xueba14.html");
        ...
        webView3.loadUrl("http://gm5s.tech:88/xueba15.html");
        ...
        webView4.loadUrl("http://gm5s.tech:88/xueba16.html");
        ...
        webView5.loadUrl("http://gm5s.tech:88/xueba17.html");
        //添加页卡视图
        mViewList.add(view1);
        mViewList.add(view2);
        mViewList.add(view3);
        mViewList.add(view4);
        mViewList.add(view5);
        mTitleList.add("全校学霸排行榜");
        mTitleList.add("14级学霸排行榜");
        mTitleList.add("15级学霸排行榜");
        mTitleList.add("16级学霸排行榜");
        mTitleList.add("17级学霸排行榜");
