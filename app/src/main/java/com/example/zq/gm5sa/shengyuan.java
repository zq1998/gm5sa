...
public class shengyuan extends  AppCompatActivity{
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_xingbie:
                        Intent intent=new Intent(shengyuan.this,xingbie_Activity.class);
                        startActivity(intent);
                        shengyuan.this.finish();
                        break;
                    case R.id.nav_xuesheng:
                        Intent intent1=new Intent(shengyuan.this,xuesheng_Activity.class);
                        startActivity(intent1);
                        shengyuan.this.finish();
                        break;
                    case R.id.nav_xiaofei:
                        Intent intent2=new Intent(shengyuan.this,xiaofei_Activity.class);
                        startActivity(intent2);
                        shengyuan.this.finish();
                        break;
                    case R.id.nav_xueba:
                        Intent intent3=new Intent(shengyuan.this,xueba_Activity.class);
                        startActivity(intent3);
                        shengyuan.this.finish();
                        break;
                    case R.id.nav_zhaosheng:
                        Intent intent4=new Intent(shengyuan.this,zhaosheng_Activity.class);
                        startActivity(intent4);
                        shengyuan.this.finish();
                        break;
                    case R.id.nav_jiuye:
                        Intent intent5=new Intent(shengyuan.this,jiuye_Activity.class);
