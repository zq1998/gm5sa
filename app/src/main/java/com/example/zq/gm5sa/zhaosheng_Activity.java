...
public class zhaosheng_Activity extends AppCompatActivity {
...
//        }
        ...
        navView.setCheckedItem(R.id.nav_zhaosheng);
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_shengyuan:
                        Intent intent4=new Intent(zhaosheng_Activity.this,MainActivity.class);
                        startActivity(intent4);
                        zhaosheng_Activity.this.finish();
                        break;
                    case R.id.nav_xingbie:
                        Intent intent=new Intent(zhaosheng_Activity.this,xingbie_Activity.class);
                        startActivity(intent);
                        zhaosheng_Activity.this.finish();
                        break;
                    case R.id.nav_xuesheng:
                        Intent intent1=new Intent(zhaosheng_Activity.this,xuesheng_Activity.class);
                        startActivity(intent1);
                        zhaosheng_Activity.this.finish();
                        break;
                    case R.id.nav_xiaofei:
                        Intent intent2=new Intent(zhaosheng_Activity.this,xiaofei_Activity.class);
                        startActivity(intent2);
                        zhaosheng_Activity.this.finish();
                        break;
                    case R.id.nav_xueba:
                        Intent intent3=new Intent(zhaosheng_Activity.this,xueba_Activity.class);
                    ...
                    case R.id.nav_zhaosheng:
                        ...
                        break;
                    case R.id.nav_jiuye:
                        Intent intent5=new Intent(zhaosheng_Activity.this,jiuye_Activity.class);
